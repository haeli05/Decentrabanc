...
import 'schema/test_record_record.dart';
...
export 'schema/test_record_record.dart';
...
/// Functions to query TestRecordRecords (as a Stream and as a Future).
Stream<List<TestRecordRecord>> queryTestRecordRecord(
        {Query Function(Query) queryBuilder,
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollection(TestRecordRecord.collection, TestRecordRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);

Future<List<TestRecordRecord>> queryTestRecordRecordOnce(
        {Query Function(Query) queryBuilder,
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollectionOnce(
        TestRecordRecord.collection, TestRecordRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);

Future<FFFirestorePage<TestRecordRecord>> queryTestRecordRecordPage({
  Query Function(Query) queryBuilder,
  DocumentSnapshot nextPageMarker,
  int pageSize,
  bool isStream,
    ...
    queryCollectionPage(
      TestRecordRecord.collection,
      TestRecordRecord.serializer,
      queryBuilder: queryBuilder,
      nextPageMarker: nextPageMarker,
      pageSize: pageSize,
      isStream: isStream,
